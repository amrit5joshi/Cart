...
$query = " SELECT `ID`, `Name`, `Image`, `Price` FROM `shoppingcart`  WHERE itemType='Wireless' order by id ASC ";
    ...
    <div class="row" align="center">
      ...
      ?>
          <div class="col-lg-3 col-md-3 col-sm-4">
            <form method="post" action="wireless.php?action=add">
              <div class="card">
