...
$query = " SELECT `ID`, `Name`, `Image`, `Price` FROM `shoppingcart`  WHERE itemType='Wired' order by id ASC ";
    ...
    <div class="row" align="center">
      ...
      ?>
          <div class="col-lg-3 col-md-3 col-sm-4">
            <form method="post" action="wired.php?action=add">
              <div class="card">
